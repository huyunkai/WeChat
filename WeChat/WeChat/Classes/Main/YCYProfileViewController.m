...
@interface YCYProfileViewController()<UIActionSheetDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate,YCYEditProfileViewControllerDelegate>
...
-(void)loadVCard{
    ...
    self.weixinNumLabel.text = [YCYUserInfo sharedYCYUserInfo].user;
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    if ([destVc isKindOfClass:[YCYEditProfileViewController class]]) {
        YCYEditProfileViewController *editVc = destVc;
        editVc.cell = sender;
...
-(void)editProfileViewControllerDidSave{
    ...
    [[YCYXMPPTool sharedYCYXMPPTool].vCard updateMyvCardTemp:myvCard];
